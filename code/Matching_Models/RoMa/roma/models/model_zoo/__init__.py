...
# def roma_outdoor(device, weights=None, dinov2_weights=None, coarse_res: Union[int,tuple[int,int]] = 280, upsample_res: Union[int,tuple[int,int]] = 512):
def roma_outdoor(device, weights=None, dinov2_weights=None, coarse_res: Union[int,tuple[int,int]] = 560, upsample_res: Union[int,tuple[int,int]] = 864):
    ...
    if dinov2_weights is None:
        ...
        dinov2_weights = torch.load(dinov2_weights, map_location=device)
